...
def load_staging_tables(cur, conn):
    """
    Loads song and log data from S3 into staging tables.
    """
...
def insert_tables(cur, conn):
    """
    Transforms and loads data from staging tables into the analytics tables.
    """
...
def main():
    """
    Executes the complete ETL pipeline for the data warehouse.
    """
    try:
